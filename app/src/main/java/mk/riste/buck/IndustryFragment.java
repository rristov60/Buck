...
public class IndustryFragment extends Fragment {
    ...
    private ArrayList<Business> getFunBusinesses() {
        ...
        Business business1 = new Business("Riste Business", "Copernicus",
                29.22, 34.55,
                "ristov@riste.mk", "+389 70 000 000", "riste.mk", Category.Industry, R.drawable.ic_fun);
        Business business2 = new Business("Ivan Business", "Copernicus",
                43.12, 44.25,
                "ivan@business.mk", "+389 71 111 111", "ivan.mk", Category.Industry, R.drawable.ic_fun);
